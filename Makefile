...
SRCS	=	main.c parser/parser.c parser/split.c parser/quoters.c parser/redirects.c parser/dollar.c \
			...
			cmd/export.c cmd/launch_exe.c cmd/execuate.c parser/ft_free_close.c parser/ft_pipe.c parser/last_command.c \
			parser/redirect_readline.c parser/redirect_utils.c parser/redirect_utils_2.c parser/parse_one_command.c \
			cmd/cd.c cmd/export_pt2.c utils/utils2.c utils/utils.c utils/utils_signals.c
...
$(OBJS_DIR)/%.o:	%.c ${HEADER}
					...
					@test -d .obj/utils || mkdir .obj/utils
